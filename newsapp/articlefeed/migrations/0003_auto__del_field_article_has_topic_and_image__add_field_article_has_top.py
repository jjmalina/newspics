...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.has_topics_and_image'
        db.add_column('articlefeed_article', 'has_topics_and_image', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Article.has_topics_and_image'
        db.delete_column('articlefeed_article', 'has_topics_and_image')
