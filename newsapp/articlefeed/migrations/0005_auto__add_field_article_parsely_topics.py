...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.parsely_topics'
        db.add_column('articlefeed_article', 'parsely_topics', self.gf('jsonfield.fields.JSONField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.parsely_topics'
        db.delete_column('articlefeed_article', 'parsely_topics')
